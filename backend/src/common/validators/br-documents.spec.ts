...
describe('teste validador de documentos', () => {
  describe('teste de digitos numericos', () => {
    // verificar se input com caracteres especiais, retorna apenas numeros
  ...
  describe('cpf valido', () => {
    // verificar aceite de cpf com ou sem mascara
    it('aceita CPF valido com ou sem mascara', () => {
      expect(isValidCpf('123.456.789-09')).toBe(true);
      expect(isValidCpf('12345678909')).toBe(true);
    });
    // rejeita cpf nao valido, conforme regra de peso para calculo
  ...
  describe('cnpj valido', () => {
    // verificar aceite de cnpj com ou sem mascara
    it('aceita CNPJ valido com ou sem mascara', () => {
      expect(isValidCnpj('11.222.333/0001-81')).toBe(true);
      expect(isValidCnpj('11222333000181')).toBe(true);
    });

    // rejeita cnpj nao valido, conforme regra de peso para calculo
